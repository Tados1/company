...
class Employee {
    ...
    public static function getAllEmployees($connection, $role = "employee", $columns = "*") {
        $sql = "SELECT $columns 
            FROM employee";
    ...
    public static function createEmployee($connection, $name, $surname, $position, $login_name, $password, $role, $employee_image) {

        $sql = "INSERT INTO employee (name, surname, position, login_name, password, role, employee_image) 
        VALUES (:name, :surname, :position, :login_name, :password, :role, :employee_image)";
    ...
    public static function editEmployee($connection, $name, $surname, $position, $login_name, $password, $id, $employee_image, $role = "employee"){
